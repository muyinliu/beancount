...
ACC_COMP_TYPE_RE = regexp_utils.re_replace_unicode(r"[\p{Lu}\p{L}\p{Nd}\p{zh-CN}\-]+")
ACC_COMP_NAME_RE = regexp_utils.re_replace_unicode(r"[\p{Lu}\p{Nd}\p{zh-CN}][\p{L}\p{Nd}\p{zh-CN}\-]*")
